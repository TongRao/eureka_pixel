    ...
    <div className="flex flex-col gap-20 pb-20">
      ...
      <Section>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          <PhotoCard src="https://images.unsplash.com/photo-1731432245368-2504b772a159?q=80&w=800&auto=format&fit=crop" alt="Mountain View" />
          <PhotoCard src="https://images.unsplash.com/photo-1732050343336-39145558d78d?q=80&w=800&auto=format&fit=crop" alt="City Lights" />
          <PhotoCard src="https://images.unsplash.com/photo-1731965097486-35366d4c0628?q=80&w=800&auto=format&fit=crop" alt="Abstract" />
        </div>
      </Section>
